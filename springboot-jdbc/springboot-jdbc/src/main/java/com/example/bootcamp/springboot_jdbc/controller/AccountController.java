...
import com.example.bootcamp.springboot_jdbc.model.Amount;
...
public class AccountController {
    ...
    @GetMapping("/hasiljoin")
    public HttpEntity<List<AccountJoin>> findAccountWithBalanceController(){
        return new ResponseEntity<>(service.findAllWithBalance(), HttpStatus.OK);
    }
